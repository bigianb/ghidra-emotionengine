...
public class EmotionEngine_ElfExtension extends MIPS_ElfExtension {
	...
	// Program Headers
	public static final ElfProgramHeaderType PT_MIPS_IRXHDR = new ElfProgramHeaderType(
		0x70000080, "PT_MIPS_IRXHDR", "IRX header");

	private static final int SHT_MIPS_IOPMOD_VALUE = 0x70000080;
	private static final int SHT_DVP_OVERLAY_TABLE_VALUE = 0x7ffff420;

	// Sections Headers
	public static final ElfSectionHeaderType SHT_MIPS_IOPMOD = new ElfSectionHeaderType(
		SHT_MIPS_IOPMOD_VALUE, "SHT_MIPS_IOPMOD", "IOP Module Information");
	...
	public static final ElfSectionHeaderType SHT_DVP_OVERLAY = new ElfSectionHeaderType(
		0x7ffff421, "SHT_DVP_OVERLAY", "A VU overlay");

	// OUT OF RANGE?
	//public static final ElfSectionHeaderType SHT_MW_CATS = new ElfSectionHeaderType(
